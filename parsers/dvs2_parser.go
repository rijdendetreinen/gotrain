...
func ParseDvs2Message(reader io.Reader) (departure models.Departure, err error) {
...
func parseDvs2Product(product *etree.Element) (departure models.Departure, err error) {
	departure.DvsVersion = 2
